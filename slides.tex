...
\begin{frame}{Intuition behind clipping}
    \begin{itemize}
        \item When the advantage is positive: $$L(s,a,\theta_k,\theta) = \min\left( \frac{\pi_{\theta}(a|s)}{\pi_{\theta_k}(a|s)}, (1 + \epsilon) \right) A^{\pi_{\theta_k}}(s,a)$$
        ...
        \item When the advantage is negative: \emph{idem} \emph{mutatis mutandis}.
    \end{itemize}
\end{frame}
...
\begin{frame}{Toolbox to cross the gap}
    \textbf{General things to do:}
    \begin{itemize}
        \item Observation-action normalization
        \item Residual reinforcement learning
        \item Curriculum learning
    \end{itemize}
    \textbf{Can help learn a more robust\footnote{Robust over model variations.} policy:}
    \begin{itemize}
...
\begin{frame}{Curriculum learning}
    \begin{itemize}
        \item Learning rate schedule: typically linear
        \item Domain randomization can vary over time
    \end{itemize}
\end{frame}
...
\begin{frame}{What we saw}
    \begin{itemize}
        ...
        \item Application to robotics: domain randomization, ``RewArt''
